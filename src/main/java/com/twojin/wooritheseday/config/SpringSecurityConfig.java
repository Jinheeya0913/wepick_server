package com.twojin.wooritheseday.config;

import com.twojin.wooritheseday.config.filter.CustomAuthenticationFilter;
import com.twojin.wooritheseday.config.filter.JwtAuthorizationFilter;
import com.twojin.wooritheseday.config.handler.CustomAuthFailureHandler;
import com.twojin.wooritheseday.config.handler.CustomAuthSuccessHandler;
import com.twojin.wooritheseday.config.provider.CustomAuthenticationProvider;
...
public class SpringSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .addFilterBefore(getJwtAuthorizationFilter(), BasicAuthenticationFilter.class)
    ...
    public CustomAuthenticationFilter customAuthenticationFilter() {
        ...
        customAuthenticationFilter.setFilterProcessesUrl("/user/fromLogin");     // 접근 URL
